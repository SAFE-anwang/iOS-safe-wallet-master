...
+ (NSAttributedString *)importantAttributeStringWithString:(NSString *)aString {
    NSMutableAttributedString *importantStr = [[NSMutableAttributedString alloc] init];
    NSAttributedString *attrStr = [[NSAttributedString alloc] initWithString:aString attributes:nil];
    [importantStr appendAttributedString:attrStr];
    NSAttributedString *redPoint = [[NSAttributedString alloc] initWithString:@" *" attributes:@{NSForegroundColorAttributeName : [UIColor redColor]}];
    [importantStr appendAttributedString:redPoint];
    return importantStr;
