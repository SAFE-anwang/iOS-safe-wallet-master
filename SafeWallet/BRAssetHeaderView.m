...
- (void)creatUI {
    ...
    UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(0, 20, SCREEN_WIDTH, 40)];
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake((SCREEN_WIDTH - 120) * 0.5, CGRectGetMaxY(lable.frame) + 20, 120, 120)];
    [self addSubview:imageView];
    self.qrImageView = imageView;
    
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(imageView.frame) + 25, SCREEN_WIDTH, 30)];
    ...
    getMoneyBtn.titleLabel.font = [UIFont systemFontOfSize:15.f];
