//
//  BRPublishIssueDataEnity+CoreDataProperties.h
//  dashwallet
//
...
#import "BRPublishIssueDataEnity+CoreDataClass.h"
#import "Safe.pbobjc.h"

NS_ASSUME_NONNULL_BEGIN

@interface BRPublishIssueDataEnity (CoreDataProperties)
...
@property (nullable, nonatomic, copy) NSString *assetAddress;
