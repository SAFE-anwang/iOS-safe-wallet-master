...
@interface BRPublishAssetSliderCell()
...
@implementation BRPublishAssetSliderCell
...
- (UILabel *)title {
    if(_title == nil) {
        ...
        _title.text = NSLocalizedString(@"Asset candy ratio:", nil);
...
- (void)sliderValueChanged:(UISlider *)slider {
    if([self.delegate respondsToSelector:@selector(publishAssetSliderCellSliderValue:)]) {
        [self.delegate publishAssetSliderCellSliderValue:slider.value];
    }
}
